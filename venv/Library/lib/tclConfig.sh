...
# installed.
TCL_PREFIX='D:/New folder (2)/City Rent/code/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/New folder (2)/City Rent/code/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/New folder (2)/City Rent/code/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/New folder (2)/City Rent/code/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/New folder (2)/City Rent/code/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/New folder (2)/City Rent/code/venv\Library\lib\tclstub86.lib'
